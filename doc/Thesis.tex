...
Během posledních let vzniklo několik projektů, které se různými způsoby snaží tomuto problému zamezit. Jsou to například způsoby domluvy různých lidí o~nespotřebovaných potravinách, při kterých lidé nabízí své nadbytečné potraviny111111111111111111111111111111111111. Ostatní se mohou domluvit a jídlo si bezplatně či za výhodnou cenu převzít. Tento způsob používa mnoho webovch i mobilních aplikací.
...
Stejně jako aplikace Best Before je tato ve verzích pro iOS i OS Android. Rozhraní aplikace je témeř identické v~obou verzích, používá styl a prvky obvyklé pouze pro iOS. Vzhled dává velmi dobrý dojem 
o~aplikaci.
...
Z~jednoduchého dema knihovny vyšlo najevo, že oproti jiným nemá tak dobré výsledky. Je tedy nutné zvážit fakt, zda-li je tato knihovna vhodná pro implementaci. Nenáročnost této knihovny však autorovi nepřijde jako dostatek pro použitelnou aplikaci. Je to dáno především tím, že výkon zařízení neustále roste a tato výhoda přestává mít svoji váhu.
