...
\subsubsection{Login}
Přihlásí uživatele pod jménem (e-mailem) a vrátí odpověď jako boolean, true pro úspěch a false pro selhání přihlášení.
...
Položky požadavku:
\begin{itemize}
  \item \textbf{direct} - boolean, hodnota určuje, zda-li je požadavek mířen přímo na id polozky inventáře nebo je hledána množina podle dalších atributů
  \item \textbf{id} - unikátní identifikátor položky inventáře
  \item \textbf{food} - název jídla nebo jen jeho část, které je hledáno
  \item \textbf{gtin} - číslo GTIN nebo jen jeho část, které je hledáno
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{useBy} - unixový čas v milisekundách (od roku 1970) dne, kdy končí trvanlivost potraviny
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{id} - unikátní identifikátor potraviny
  \item \textbf{food} - název jídla, které je hledáno
  \item \textbf{gtin} - číslo GTIN, které je hledáno
...
\begin{itemize}
  ...
  \item \textbf{defaultUseBy} - výchozí datum spotřeby
  \item \textbf{imageId} - unikátní identifikátor nějakého obrázku, pokud existuje, jinak 0
  \item \textbf{name} - jméno potraviny nebo jen jeho část, které je hledáno
...
Položky požadavku:
\begin{itemize}
  \item \textbf{imageData} - řetězec s daty obrázku
  \item \textbf{foodId} - unikátní identifikátor potraviny
\end{itemize}
