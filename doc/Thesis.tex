...
Po dokončení implementace aplikace a otestování aplikace programátorem jsem uskutečnil usability test, který má za úkol zhodnotit celkovou použitelnost aplikace na skupině lidí. Tito lidé budou podrobeni sledovaním při provádění předem daných scénářů, které pokryjí běžné činnosti s aplikací a jednotlivé reakce uživatelů budou zaznamenány pro každý scénář. U nich bude také sepsán předpokládaný způsob jejich řešení..

Pro další zisk informací od uživatelů budou položeny níže popsané dotazníky pre-test a post-test.

\subsection{Příprava testu}

Jednotlivé scénáře jsou očíslované tak, jak budou níže popsány pozorované reakce a zkušenosti uživatelů při jejich provádění.
...
\begin{enumerate}
  ...
  \item Odeberte Vámi zvolenou potravinu, která už je v inventáři, pomocí skenování čárového kódu z vašeho inventáře.
...
\begin{enumerate}
  \item V tomto úkolu se uživateli podařilo dosáhnout řešení přesně dle scénáře.
  \item V tomto úkolu se uživateli podařilo dosáhnout řešení přesně dle scénáře.
  \item V tomto úkolu se uživateli podařilo dosáhnout řešení přesně dle scénáře.
  \item V tomto úkolu se uživateli podařilo dosáhnout řešení přesně dle scénáře.
  \item V tomto úkolu se uživateli podařilo dosáhnout řešení přesně dle scénáře.
