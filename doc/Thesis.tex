...
V testu číslo jedna byl uživatel ve věkové kategorii 20-30 let s mobilním telefonem Huawei M886.
...
V testu číslo jedna byl uživatel ve věkové kategorii 50-60 let s mobilním zařízením Xperia sola (MT27i).

\begin{enumerate}
  \item V tomto úkolu byl uživatel zmatený, zběsile klikal v inventáři místo toho, aby klikl na menu. Dále byl uživatel zmatený při zadání výchozího data spotřeby. Myslel si totiž, že to už je datum spotřeby té dané potraviny.
  \item V tomto úkolu se uživateli podařilo dosáhnout řešení přesně podle daného scénáře.
  \item V tomto úkolu se uživateli podařilo dosáhnout řešení přesně podle daného scénáře.
  \item V tomto úkolu se uživateli podařilo dosáhnout řešení přesně podle daného scénáře.
  \item V tomto úkolu se uživateli podařilo dosáhnout řešení přesně podle daného scénáře.
...
V testu číslo jedna byl uživatel ve věkové kategorii 20-30 let s mobilním zařízením Huawei G700. Aplikaci již v průběhu vývoje zkoušel.
...
V testu číslo jedna byl uživatel ve věkové kategorii 20-30 let s mobilním zařízením Huawei G700.
...
% Toto testování má za účel odhalit chyby v~uživatelském rozhraní, které nebyli odstraněny při návrhu, ale projevily se až při skutečné uživatelské interakci. Pro testování byla použita alfa verze, % která ještě neobsahovala veškerou funkčnost aplikace. Proto se testovaly především nedávno přidané změny.
