...
Vydáním beta verze aplikace na Play Store byla plně naimplementovaná aplikace testována přímo samotnými uživateli. V době psaní této práce se tohoto testování zučastnilo 5 osob různých věkových kategorií.

Průběh tohoto testování záležel na samotných uživatelích. Uživatelé měli možnost se k aplikaci vyjádřit na přání autora.

Poznatky z tohoto testování zahrnovali ..
