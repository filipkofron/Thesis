...
static const char *FIND_FOOD_BY_NAME = "SELECT id, gtin, name, description, category_id, default_use_by, amount_measure, amount, user_id, price, vendor_id FROM Food WHERE name LIKE ?";
static const char *FIND_FOOD_BY_GTIN = "SELECT id, gtin, name, description, category_id, default_use_by, amount_measure, amount, user_id, price, vendor_id FROM Food WHERE gtin LIKE ?";
